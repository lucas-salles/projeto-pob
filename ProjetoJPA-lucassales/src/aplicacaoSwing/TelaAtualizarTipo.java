...
public class TelaAtualizarTipo {
...
//			public void run() {
//				try {
//					TelaAtualizarTipo window = new TelaAtualizarTipo();
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if(textField.getText().isEmpty() || textField_1.getText().isEmpty())
						...
						String nometipo = textField.getText();
						String novonome = textField_1.getText();
						Fachada.alterarTipo(nometipo, novonome);
						textField.setText("");
						textField_1.setText("");
